...
const kBottomContainerHeightColor = Color(0xFFEB1555);
const kDimensionsTextStyle = TextStyle(fontSize: 50.0, fontWeight: FontWeight.w900);
...
const kResultTextStyle = TextStyle(fontSize: 22, fontWeight: FontWeight.bold, color: Color(0xFF24D876));
